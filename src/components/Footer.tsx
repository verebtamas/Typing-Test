...
export default function Footer() {
    ...
    useEffect(() => {
        const URL =
            "https://api.github.com/repos/verebtamas/typing-test/contributors";
        fetch(URL)
            .then((res) => res.json())
            .then((data: Contributor[]) =>
                data.filter(
                    (contributor) => contributor.login !== "verebtamas"
                )
            )
        ...
        <div className={`bottom-area ${timerId ? "hidden" : ""}`}>
            ...
            <footer>
                <a
                    target="_blank"
                    rel="noreferrer"
                    href="https://www.github.com/verebtamas/typing-test">
                    <span>&lt;/&gt;</span> github
                </a>
                <span>
                    created by{" "}
                    <a
                        target="_blank"
                        rel="noreferrer"
                        href="https://www.github.com/verebtamas">
                        @verebtamas
                    </a>
                </span>
                {showList ? (
